...
function createWebSocket() {
    var host = "121.43.151.199:8071";//"121.43.151.199"; ///window.location.host; // 带有端口号
...
var heartCheck = {
    //15S之内如果没有收到后台的消息，则认为是连接断开了，则需要再次连接
    timeout: 15000,
    timeoutObj: null,
        ...
        this.timeoutObj = setTimeout(
            function () {
                ...
                self.serverTimeoutObj = setTimeout(function () {
                    //如果onclose会执行reconnect,我们执行ws.close()就行了，若果直接执行reconnect会触发onclose导致重连两次
